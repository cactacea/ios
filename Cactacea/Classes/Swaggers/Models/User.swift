...
open class User: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        tweetCount = try container.decode(Int64.self, forKey: "tweetCount")
