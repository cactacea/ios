...
open class Channel: Codable {
    ...
    public init(id: Int64, name: String?, message: Message?, invitationOnly: Bool, privacyType: PrivacyType, authorityType: AuthorityType, userCount: Int64, lastPostedAt: Int64?, organizedAt: Int64, next: Int64?) {
        self.id = id
        self.name = name
