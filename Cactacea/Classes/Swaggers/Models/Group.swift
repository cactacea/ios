...
open class Group: Codable {
    ...
    public init(id: Int64, name: String?, message: Message?, groupPrivacyType: GroupPrivacyType, invitationOnly: Bool, authorityType: AuthorityType, accountCount: Int64, organizedAt: Int64, next: Int64) {
        self.id = id
        self.name = name
