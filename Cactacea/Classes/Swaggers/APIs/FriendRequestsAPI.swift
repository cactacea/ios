...
open class FriendRequestsAPI {
     ...
     */
    open class func accept(id: Double, completion: @escaping ((_ error: Error?) -> Void)) {
     ...
     */
    open class func accept(id: Double) -> Observable<Void> {
     ...
     */
    open class func acceptWithRequestBuilder(id: Double) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createFriendRequest(id: Double, completion: @escaping ((_ data: FriendRequestCreated?,_ error: Error?) -> Void)) {
     ...
     */
    open class func createFriendRequest(id: Double) -> Observable<FriendRequestCreated> {
        return Observable.create { observer -> Disposable in
  ...
  "id" : 0.80082819046101150206595775671303272247314453125
     ...
     */
    open class func createFriendRequestWithRequestBuilder(id: Double) -> RequestBuilder<FriendRequestCreated> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteRequest(id: Double, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func deleteRequest(id: Double) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteRequestWithRequestBuilder(id: Double) -> RequestBuilder<Void> {
        var path = "/accounts/{id}/requests"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = CactaceaAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func findSessionFriendRequests(received: Bool, since: Double? = nil, offset: Double? = nil, count: Double? = nil, completion: @escaping ((_ data: [FriendRequest]?,_ error: Error?) -> Void)) {
     ...
     */
    open class func findSessionFriendRequests(received: Bool, since: Double? = nil, offset: Double? = nil, count: Double? = nil) -> Observable<[FriendRequest]> {
        return Observable.create { observer -> Disposable in
  ...
  "requestStatus" : "noResponded"
     ...
     */
    open class func findSessionFriendRequestsWithRequestBuilder(received: Bool, since: Double? = nil, offset: Double? = nil, count: Double? = nil) -> RequestBuilder<[FriendRequest]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func reject(id: Double, completion: @escaping ((_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func reject(id: Double) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func rejectWithRequestBuilder(id: Double) -> RequestBuilder<Void> {
