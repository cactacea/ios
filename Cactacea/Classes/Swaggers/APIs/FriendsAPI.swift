...
open class FriendsAPI {
     ...
     */
    open class func deleteFriend(id: Int64, completion: @escaping ((_ error: Error?) -> Void)) {
        deleteFriendWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error);
        }
    }
     ...
     */
    open class func deleteFriend(id: Int64) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            deleteFriend(id: id) { error in
                if let error = error {
     ...
     */
    open class func deleteFriendWithRequestBuilder(id: Int64) -> RequestBuilder<Void> {
